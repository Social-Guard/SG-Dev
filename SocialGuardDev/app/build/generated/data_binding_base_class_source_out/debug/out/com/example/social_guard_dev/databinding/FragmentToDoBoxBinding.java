...
public final class FragmentToDoBoxBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentToDoBoxBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentToDoBoxBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_to_do_box, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentToDoBoxBinding bind(@NonNull View rootView) {
