...
public abstract class Hilt_AchievementsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AchievementsFragment() {
    super();
  }

  Hilt_AchievementsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AchievementsFragment_GeneratedInjector) this.generatedComponent()).injectAchievementsFragment(UnsafeCasts.<AchievementsFragment>unsafeCast(this));
    }
  }
